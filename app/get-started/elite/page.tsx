...
export default function EliteGetStartedPage() {
  ...
  const plan = {
    ...
    description: 'This package gives you total marketing dominance. From custom websites and ad systems to 24/7 AI automation, everything is built to grow your business faster, smarter, and with less effort.',
    whatYouGet: 'Potentially bring in 50+ new potential client inquiries per month, expand your brand\'s reach nationwide, and attract high value clients through a fully automated AI driven growth system, plus ad spend.',
    potentialClients: '50+ inquiries/month',
    features: [
      'Everything in the Growth Service',
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          {/* Main Card */}
          <Card className="mb-8 shadow-xl border-2 border-purple-500">
            ...
            <CardContent className="p-8">
              ...
              <div className="bg-green-50 rounded-lg p-6 mb-8 border-l-4 border-green-500">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 mt-1">nationwide reach + AI automation</p>
                </div>
              </div>
                ...
                <div className="text-center mb-6">
                  ...
                  {billingPeriod === 'annual' ? (
                    <>
                      {/* Setup Fee */}
                      <div className="mb-4">
                        <span className="text-3xl font-bold text-purple-600">{plan.setupFee}</span>
                      ...
                      <div className="border-t-2 border-purple-300 pt-4 mb-4">
                        ...
                        <div className="bg-white rounded-lg p-4 mb-3 border-2 border-green-500">
                          ...
                          <span className="text-5xl font-bold text-green-700">£26,625</span>
                        ...
                        <div className="bg-purple-100 rounded-lg p-3 mb-3">
                          ...
                          <span className="text-2xl font-bold text-purple-700">£79,875</span>
                    ...
                    <>
                      {/* Monthly Billing */}
                      <div className="mb-4">
                        <span className="text-5xl font-bold text-purple-600">{plan.setupFee}</span>
